...
function Hero() {
  return (
    <section id="home" className="xl:pt-10 lg:pt-16 md:pt-20 sm:pt-24 pt-28 min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100 dark:from-gray-950 dark:via-blue-900/40 dark:to-purple-800/80 transition-colors duration-300 relative overflow-hidden">
